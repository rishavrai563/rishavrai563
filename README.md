...
I'm **Rishav**, an **AI and Data Engineering** undergraduate at **sAIDE, IIT Ropar**.

I build scalable software — from **C++ system tools** to **full-stack machine learning pipelines** — with a sharp focus on applying engineering to the **financial sector**: quantitative trading, risk management, and market microstructure.

- 🔭 Currently working on **quantitative trading systems** and **operational risk engines**
- 🧬 Research interests: **Financial ML**, **Bayesian Optimization**, **NLP for markets**
- ⚡ I ship production-grade code, not prototypes
...
[![GitHub Streak](https://streak-stats.demolab.com?user=rishavrai563&theme=react&hide_border=true&background=0D1117&stroke=58A6FF&ring=58A6FF&fire=FF6E40&currStreakLabel=58A6FF)](https://git.io/streak-stats)
